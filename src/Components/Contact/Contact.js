    ...
    <div className={styles.header}>
      ...
      <div className={styles.contact}>
        ...
        <div className={styles.details}>
          <div><i className="fa fa-map-marker"></i></div><div>Melbourne, Australia</div>
          <div><i className="fa fa-envelope"></i></div><div>istangyf@gmail.com</div>
          <div><i className="fa fa-phone"></i></div><div>+61 425 690 913</div>
          <div><i className="fa fa-check"></i></div><div>Freelance Available</div>
        </div>
        </div>
